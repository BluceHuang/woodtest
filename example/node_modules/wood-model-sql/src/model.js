...
Model.DataTypes = Sequelize.DataTypes;
for (const dataType in Model.DataTypes) {
  Model[dataType] = Model.DataTypes[dataType];
}

Model.prototype.Op = Model.Op = Sequelize.Op;
Model.prototype.Validator = Sequelize.Validator = Sequelize.Validator;
Model.prototype.Transaction = Model.Transaction = Sequelize.Transaction;
